...
type ViewState = "home" | "explore" | "profile" | "search" | "detail" | "travel";
      ...
      default:
        return (
          <div className="pb-24">
            ...
            <FeaturedSection onCardClick={handleCardClick} />
            <NearbySection onTourClick={handleCardClick} />
          </div>
        );
    }
  };
  ...
  return (
    <div className="flex justify-center bg-background min-h-screen">
      <div className="max-w-[420px] w-full min-h-screen relative">
        {renderContent()}
        {(view === "home" || view === "explore" || view === "profile") && (
